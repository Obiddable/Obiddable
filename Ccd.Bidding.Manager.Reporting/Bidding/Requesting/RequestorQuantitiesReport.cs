...
public class RequestorQuantitiesReport : BidHtmlReportBuilder
{
   private readonly IRequestingRepo _requestingRepo = new EFRequestingRepo();
   protected override string Title => "Bid Requestors' Requested Quantities Report";
   protected override string StyleName => "Reports.BidRequestMatrix.css";
   protected override PrintOrientation PrintOrientation => PrintOrientation.Landscape;

   public RequestorQuantitiesReport() : base()
   {
   }
